...
List<Cashouts> cashoutsFromJson(String str) => List<Cashouts>.from(json.decode(str).map((x) => Cashouts.fromJson(x)));

String cashoutsToJson(List<Cashouts> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

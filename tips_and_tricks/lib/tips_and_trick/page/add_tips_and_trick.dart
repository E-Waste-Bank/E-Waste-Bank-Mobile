import 'package:e_waste_bank_mobile/tips_and_trick/util/add_tips_and_trick.dart';
import 'package:flutter/material.dart';
import 'package:tips_and_trick/model/TipsAndTrick.dart';
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(
                      child: Text(_publised_date == null ? "Pick a date" : "${_publised_date!.day}/${_publised_date!.month}/${_publised_date!.year}"),
                      onPressed: () {
                        showDatePicker(
                          context: context,
                    ...
                    Align(
                      ...
                      child: TextButton(
                        ...
                        onPressed: (){
                          if (_formKey.currentState!.validate() && _publised_date != null){
                            String publisedDate = _publised_date.toString().substring(0, 10);
                            TipsAndTrick tipsAndTrick = new TipsAndTrick(title: title, source: source, published_date: publisedDate, brief_description: brief_description, image_url: image_url, article_url: article_url);

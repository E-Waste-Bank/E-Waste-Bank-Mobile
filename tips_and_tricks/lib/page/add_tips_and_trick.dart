                          ...
                          children: [
                            TextFormField(
                                decoration: InputDecoration(
                                  hintText:
                                      "Contoh: Kelebihan dari memakai totebag",
                                  labelText: "Title",
                            ...
                            TextButton(
                              child: Text(_publised_date == null
                                  ? "Pick a date"
                                  : "${_publised_date!.day}/${_publised_date!.month}/${_publised_date!.year}"),
                              onPressed: () {
                                showDatePicker(
                                  context: context,
                            ...
                            TextFormField(
                                decoration: InputDecoration(
                                  hintText:
                                      "Contoh: https://www.genevaenvironmentnetwork.org/wp-content/uploads/2020/09/ewaste-aspect-ratio-2000-1200-1024x614.jpg",
                                  labelText: "Image URL",
                                  // icon: const Icon(Icons.add_circle),
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(5.0),
                            ...
                            TextFormField(
                                decoration: InputDecoration(
                                  hintText:
                                      "Contoh: https://www.theartofsimple.net/10-ways-to-recycle-your-technology-and-manage-e-waste/",
